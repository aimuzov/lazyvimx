...
Полный справочник по всем 49 экстрам lazyvimx.
...
- `core.extras` — все 48 экстр из реестра
...
Реестр всех 48 функциональных экстр (все категории, кроме `colorschemes`) — один импорт вместо
...
| DAP          | 1      | Отладка                                    |
| Test         | 1      | Тестирование                               |
| **Итого**    | **49** | плюс 5 core-модулей для включения наборами |
