...
Формат и значения по умолчанию — в [CONFIGURATION.ru.md](CONFIGURATION.ru.md#функция-setup).
...
Полный справочник — в [API.ru.md](API.ru.md#utilgeneral).
...
сайдбары согласованы между собой. Справочник — в [API.ru.md](API.ru.md#utillayout).
