...
### Можно ли подключить свою цветовую схему?

Да — добавьте своё семейство в `colorscheme_households`
([формат](CONFIGURATION.ru.md#🎨-цветовые-схемы)). Но кастомные хайлайты lazyvimx есть только для
